...
<script src="https://kit.fontawesome.com/e1eaef53f0.js" crossorigin="anonymous"></script>
	...
	<div class="hdiv">
		...
		<form method="post">
                        ...
                        <p id=textdecors id=removepadding>Name with initials:</p>
			<input type="text" id="name" name="user_name1" placeholder="Enter your name with initials">
			<br />
                        <p id=textdecors id=removepadding>Full Name:</p>
			<input type="text" id="fullname" name="user_name2" placeholder="Enter your full name">
			<br />
                        <p id=textdecors id=removepadding>Date of Birth:</p>
                        <input type="date" id="birthday" name="birthday">
                        <br />
                        <p id=textdecors id=removepadding>Gender:</p>
                        ...
                        <br><br>
                        <p id=textdecors id=removepadding>Address:</p>
                        <input type="text" id="address" name="useraddress" placeholder="Enter your address"><br><br>
                        <p id=textdecors id=removepadding>Contact number:</p>
                        <input type="text" id="contact" name="usercontact" placeholder="Enter your contact number"><br><br>
			<p id=textdecors id=removepadding>Email:</p>
			<input type="text" id="email" name="email" placeholder="Enter your email address"><br><br>
                        <p id=textdecors id=removepadding>Mother's Maiden Name (For Security Purposes):</p>
                        <input type="text" id="guardianname" name="userguardianname" placeholder="Enter your Mother's Maiden Name"><br><br>
                        <p id=textdecors id=removepadding>New Password:</p>
			<input type="password" id="pass" name="pass" placeholder="Enter your new password"><br><br>
                        <p id=textdecors id=removepadding>Confirm Password:</p>
